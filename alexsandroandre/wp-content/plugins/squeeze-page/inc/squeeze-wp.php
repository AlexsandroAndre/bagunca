...
if ($option == false) {
    ?>
    <div id="alerta" class="alert alert-danger" role="alert">A versão GRÁTIS foi habilitada! Isso acontece quando você está usando a versão GRATUITA ou quando a sua chave de ativação está incorreta!</div>
    <?php
} else {
    ?>
