...
class Odin_Theme_Options {
    ...
    public function add_page() {
        add_theme_page(
                $this->title, $this->title, $this->capability, $this->id, array(&$this, 'settings_page')
        );
    }
    ...
    public function settings_page() {
        ...
        /*if (isset($_POST) && $current_tab == 'cores') {
            $nome_arquivo = get_template_directory() . '/assets/css/color.css';
    ...
    public function create_settings() {
        ...
        foreach ($this->fields as $section => $items) {
            ...
            add_settings_section(
                    $section, $items['title'], '__return_false', $items['tab']
            );
            foreach ($items['fields'] as $option) {
                ...
                add_settings_field(
                        $option['id'], $option['label'], array(&$this, 'callback_' . $type), $items['tab'], $section, $args
                );
            }
        }
