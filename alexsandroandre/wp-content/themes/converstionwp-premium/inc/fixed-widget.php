...
class q2w3_fixed_widget { // Plugin class
	...
	public static function init() {
		...
		if ( is_admin() ) {
			...
			wp_enqueue_script('q2w3-fixed-widget', get_template_directory_uri() . '/assets/js/q2w3-fixed-widget.min.js', array('jquery'), self::VERSION);
	...
	public static function add_widget_option($widget, $return, $instance) {  
		...
		echo '<label for="'. $widget->get_field_id('q2w3_fixed_widget') .'">'. 'Fixar Widget' .'</label>'.PHP_EOL;
